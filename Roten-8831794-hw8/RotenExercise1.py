...
#not sure what an npz file is and why he is using it --> the npz file is like a text file with all the data we need, it is just in a format specific to numpy.
...
#
#Cladio defines this, but I need to change this to accept the data format that I am entering
#
