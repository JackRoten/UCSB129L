...
parser.add_argument('-N','--NNumber',  type=int, required=True, help='5')
parser.add_argument('-mu','--muNumber', type=int, required=True, help='3')
parser.add_argument('-sigma','--sigmaNumber', type=float, required=True, help='0.5')
